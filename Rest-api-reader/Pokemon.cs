...
namespace Rest_api_reader
{
    ...
    public partial class Pokemon
    {
        ...
        {
            return JsonConvert.DeserializeObject<Pokemon>(json, Rest_api_reader.Converter.Settings);
        }
    }

    public static class Serialize
    {
        public static string ToJson(this Pokemon self)
        {
            return JsonConvert.SerializeObject(self, Rest_api_reader.Converter.Settings);
        }
    }
